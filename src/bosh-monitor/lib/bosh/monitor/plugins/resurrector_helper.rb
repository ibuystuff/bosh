  ...
  module ResurrectorHelper
    ...
    class AlertTracker
      ...
      def record(agent_key, alert)
        if [Bosh::Monitor::Events::Alert::CATEGORY_VM_HEALTH, Bosh::Monitor::Events::Alert::CATEGORY_DEPLOYMENT_HEALTH].include?(alert.category) && UNHEALTHY.include?(alert.severity)
